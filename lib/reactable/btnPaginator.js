...
var BtnPaginator = (function (_React$Component) {
    ...
    _createClass(BtnPaginator, [{
        ...
        value: function renderPrevious() {
            ...
            return _react2["default"].createElement("button", { className: "reactable-previous-page " + (canPage ? "" : "disabled"),
        ...
        value: function renderNext() {
            ...
            return _react2["default"].createElement("button", { className: "reactable-next-page " + (canPage ? "" : "disabled"),
                href: pageHref(this.props.currentPage + 1),
