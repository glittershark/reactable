...
Table.propTypes = {
    sortBy: _propTypes2['default'].bool,
    itemsPerPage: _propTypes2['default'].number, // number of items to display per page
    filterable: _propTypes2['default'].array, // columns to look at when applying the filter specified by filterBy
    filterBy: _propTypes2['default'].string, // text to filter the results by (see filterable)
    hideFilterInput: _propTypes2['default'].bool, // Whether the default input field for the search/filter should be hidden or not
    hideTableHeader: _propTypes2['default'].bool, // Whether the table header should be hidden or not
    noDataText: _propTypes2['default'].string, // Text to be displayed in the event there is no data to show
    noDataComponent: _propTypes2['default'].func // function called to provide a component to display in the event there is no data to show (supercedes noDataText)
};
