...
describe('Reactable', function() {
    ...
    describe('Adding a <Tfoot>', function() {
        before(function() {
            ReactDOM.render(
                <Reactable.Table className="table" id="table" sortable={['Name']} filterableColumns={['Name', 'Age']} filterClassName="new-class" >
    ...
    describe('filtering', function() {
        ...
        describe('basic case-insensitive column filtering', function(){
            before(function() {
                this.component = ReactDOM.render(
                    <Reactable.Table className="table" id="table"
                        filterableColumns={['State', 'Tag']}
        ...
        context('with custom column filter', function() {
            before(function() {
                this.component = ReactDOM.render(
                    <Reactable.Table className="table" id="table"
                        filterableColumns={[
        ...
        describe('basic case-insensitive row filtering', function(){
            before(function() {
                this.component = ReactDOM.render(
                    <Reactable.Table className="table" id="table"
                        filterRows={true}
            ...
            context('from the filterer field', function() {
                it('filters case insensitive on specified columns', function() {
                    ...
                    $filter.val('old New Mexico');
                    React.addons.TestUtils.Simulate.keyUp($filter[0]);

                    ReactableTestUtils.expectRowText(0, ['New Mexico', 'lorem ipsum', 'old']);
                });
            ...
            context('from filterBy prop', function() {
                before(function() {
                  ...
                  var ParentComponent = React.createClass({
                    getInitialState: function() {
                      return {customFilterText: 'old Colorado'}
                    },
                ...
                it('filters case insensitive on specified columns', function() {
                  ReactableTestUtils.expectRowText(0, ['Colorado', 'new description that shouldnt match filter', 'old']);
                  var $builtInFilter = $('#table thead tr.reactable-filterer input.reactable-filter-input');
                  expect($builtInFilter).to.have.value('new');
                  ...
                  ReactableTestUtils.expectRowText(0, ['Colorado', 'new description that shouldnt match filter', 'old']);
                  expect($builtInFilter).to.have.value('colorado');
                });
            });
        })
    });
